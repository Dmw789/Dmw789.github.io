...
function App(){
    ...
    const ramble = `For as long as I can remember, gaming has meant a lot to me. Whether that be connecting with family and friends 
                    ...
                    and systems.
                    `;
    const projects = [{label: "Investifull", link: "", image:"./src/assets/in1.png", description: "Old project that needs to be replaced", preview:"./src/assets/in1.png"}, {label: "Do the Lawn", link: "", image:"./src/assets/dtl1.png", description: "A 3D chore-based chaos simulator. Developed in Unreal Engine 4.", preview:"./src/assets/dtl.gif"}, {label: "Project Gradual", link: "", image:"./src/assets/pg1.png", description: "A 3D racing game inspired by anti-gravity racers of the 90's. Developed in Unreal Engine 4 using C++ in Visual Studio.",  preview:"./src/assets/pg.gif"}, {label: "Manorbound", link: "", image:"./src/assets/mb1.png", description: "A 3D horror game where 1-4 players have to go around solving puzzles in order to solve the mystery of the haunted manor. Developed in Unreal Engine 4.",  preview:"./src/assets/mb.gif"}, {label: "Independent Study", link: "", image:"./src/assets/bg1.png", description: "Old project. Needs to be replaced.",  preview:"./src/assets/bg1.png"}]
    const posts = [{label: "About This Blog", link: "", image: "./src/assets/pg1.png", description: "abc"}, {label: "The Anti-Gravity Effect", link: "", image: "./src/assets/pg1.png", description: "abc"}, {label: "On Fighting Games and 'Arbitrary' Mechanics", link: "", image: "./src/assets/pg1.png", description: "abc"}, {label: "At Bat For Hard Mode", link: "", image: "./src/assets/pg1.png", description: "abc"}];
